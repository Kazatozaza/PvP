                    ...
                    if not inSafeZone then
                        ...
                        if pvpDisabled ~= true then
                            ...
                            if isLevelValid then
                                ...
                                -- **เพิ่มเงื่อนไขตรวจสอบระยะทาง: ถ้ามากกว่า 10000 จะไม่สนใจ**
